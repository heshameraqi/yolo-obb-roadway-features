...
parser.add_argument("--weights_path", type=str, default="yolov3_weights.pth", help="path to weights file")
...
dataloader = torch.utils.data.DataLoader(
    ListDataset(train_path, val=True), batch_size=opt.batch_size, shuffle=False, num_workers=opt.n_cpu
)
